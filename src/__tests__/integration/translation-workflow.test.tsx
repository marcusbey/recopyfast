...
describe("Translation Workflow Integration", () => {
    ...
    it("should successfully translate content elements", async () => {
      ...
      expect(data).toMatchObject({
        ...
        message: expect.stringContaining(
          "Successfully translated 2 elements to es",
        ),
      });
    });
  ...
  describe("Translation Dashboard Component Integration", () => {
    ...
    it("should handle translation workflow", async () => {
      ...
      expect(
        screen.getByText(/Successfully translated 3 elements to French/),
      ).toBeInTheDocument();
    ...
    it("should handle translation errors", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(
            /Missing required fields|Translation service unavailable/,
          ),
        ).toBeInTheDocument();
      });
  ...
  describe("Complete Translation Workflow", () => {
    it("should complete full translation workflow from selection to results", async () => {
      ...
      expect(
        screen.getByText(/Successfully translated 2 elements to German/),
      ).toBeInTheDocument();
    ...
    it("should handle multiple translation requests in sequence", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Successfully translated 3 elements to Spanish/),
        ).toBeInTheDocument();
      });
    ...
    it("should maintain state during error recovery", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Successfully translated 2 elements to French/),
        ).toBeInTheDocument();
      });

      // Error should be cleared
      expect(
        screen.queryByText("Translation service unavailable"),
      ).not.toBeInTheDocument();
    });
  });
});
