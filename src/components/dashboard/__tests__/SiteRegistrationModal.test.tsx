...
describe("SiteRegistrationModal", () => {
  ...
  describe("Initial Rendering", () => {
    it("should render the modal when isOpen is true", () => {
      ...
      expect(
        screen.getByText(
          /Add a new website to start making your content editable/i,
        ),
      ).toBeInTheDocument();
    });
    ...
    it("should render submit and cancel buttons", () => {
      ...
      expect(
        screen.getByRole("button", { name: /Register Site/i }),
      ).toBeInTheDocument();
      expect(
  ...
  describe("Form Validation", () => {
    it("should show error when website name is empty", async () => {
      ...
      expect(
        await screen.findByText("Website name is required"),
      ).toBeInTheDocument();
    ...
    it("should show error for invalid URL format", async () => {
      ...
      expect(
        await screen.findByText(/Please enter a valid domain/i),
      ).toBeInTheDocument();
      expect(global.fetch).not.toHaveBeenCalled();
    });
    ...
    it("should clear field errors when user starts typing", async () => {
      ...
      expect(
        screen.queryByText("Website name is required"),
  ...
  describe("Error Handling", () => {
    it("should handle duplicate domain error", async () => {
      ...
      expect(
        await screen.findByText("This domain is already registered"),
      ).toBeInTheDocument();
    });
