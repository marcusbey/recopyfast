...
jest.mock("framer-motion", () => ({
  motion: {
    ...
    img: ({ children, ...props }: React.ComponentProps<"img">) => (
...
describe.skip("InteractiveHero", () => {
  describe("Initial Rendering", () => {
    it("should render with default content", () => {
      ...
      expect(
        screen.getByText(
          "With just one script tag, edit your entire site in real-time.",
        ),
      ).toBeInTheDocument();
    ...
    it("should render interactive demo banner", () => {
      ...
      expect(
        screen.getByText(/Click any text below to edit it in real-time/),
      ).toBeInTheDocument();
    ...
    it("should render code preview section", () => {
      ...
      expect(
        screen.getByText("That's it! Your website becomes instantly editable."),
      ).toBeInTheDocument();
    });
  ...
  describe("Text Editing Functionality", () => {
    ...
    it("should save changes when Enter is pressed", async () => {
      ...
      expect(
        screen.queryByDisplayValue("New Headline Text"),
    ...
    it("should only allow one text to be edited at a time", async () => {
      ...
      await user.click(headline);
      expect(
        screen.getByDisplayValue("Transform Your Website"),
      ).toBeInTheDocument();

      await user.click(subheading);
      expect(
        screen.queryByDisplayValue("Transform Your Website"),
      ).not.toBeInTheDocument();
      expect(
  ...
  describe("Success Animation", () => {
    it("should show success animation when text is saved", async () => {
      ...
      expect(
        screen.getByText("Content updated instantly!"),
      ).toBeInTheDocument();
      ...
      expect(
        screen.queryByText("Content updated instantly!"),
      ).not.toBeInTheDocument();
    });
  });
  ...
  describe("Auto Demo Functionality", () => {
    ...
    it("should update texts during auto demo sequence", async () => {
      ...
      expect(
        screen.getByDisplayValue("Transform Any Website Instantly"),
      ).toBeInTheDocument();
      ...
      expect(
        screen.getByDisplayValue(
          "AI-powered content editing with real-time collaboration.",
        ),
      ).toBeInTheDocument();
  ...
  describe("Hover and Interaction States", () => {
    ...
    it("should not show edit tooltip for CTA button", () => {
      ...
      expect(
        ctaButton.parentElement?.querySelector('[class*="group"]'),
      ).toBeTruthy();
    });
  });
  ...
  describe("Component State Management", () => {
    it("should maintain separate state for each editable text", async () => {
      ...
      await user.click(subheading);
      const subheadingInput = screen.getByDisplayValue(
        "With just one script tag, edit your entire site in real-time.",
      );
